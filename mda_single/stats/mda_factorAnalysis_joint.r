...
##prepare joint dataset of traditional and core registers

#read in matrices containing all normalised frequencies per feature as columns; read in as data.frame
