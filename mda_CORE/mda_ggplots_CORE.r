###R commands for creating plots of podcasts and computer-mediated registers as
###presented in Ehret, Katharina, Laurens Bosman, Aminat Babayode, Nicole Chan,
###Ivan Fong, Noelle Harris, Alissa Hewton, Danica Reid, Rebekah Wong, Maite
...
loadings = read.csv("stats/loadings_CORE.csv") #change path(s) if applicable throughout script to read in data!
